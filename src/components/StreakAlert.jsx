...
export default function StreakAlert({ dias, onIr }) {
  return (
    <div className="mt-6 flex items-center gap-3 rounded-2xl border border-gold/40 bg-gold/10 p-4 animate-slideUp">
      <span className="text-3xl animate-shake">🔥</span>
      <div className="min-w-0 flex-1">
        <p className="font-display text-sm font-bold text-gold">Tu racha está en peligro</p>
